<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/template/empty/empty.Master" CodeBehind="index.aspx.vb" Inherits="contentoom.authIndex" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Вход
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderEmpty" runat="server">
    <div class="auth-area">
	...
	<!--			Забыли свой пароль?-->
				<noindex>
					<div class="auth_txt botmarg37">
						<a href="/auth/restore-password.php" rel="nofollow">Забыли свой пароль?</a>
					</div>
				</noindex>
	...
	<!--			Зарегестрироваться/Войти-->
				<div class="auth_btn">
					<div>
						<a href="/auth/registration.php" rel="nofollow" class="button orange">ЗАРЕГЕСТРИРОВАТЬСЯ</a>
					</div>
